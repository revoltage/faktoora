...
import {
  ...
  NOT_NEEDED,
} from "@/components/TransactionInvoiceBindingModal";
...
export function TransactionList({
  ...
  const visibleTransactions = showFiltered
    ...
    : transactions;
  const unresolvedTransactions = visibleTransactions.filter(
    (transaction) => !transaction.boundInvoiceStorageId,
  );
  const solvedTransactions = visibleTransactions.filter((transaction) =>
    Boolean(transaction.boundInvoiceStorageId),
  );
